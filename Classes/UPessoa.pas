...
type
  ...
  public
    ...
    procedure ConsultarPorCpfCnpj(CPF_CNPJ: string);
...
begin
     ...
     try
            ...
            Query.SQL.Text := 'SELECT * FROM PESSOA WHERE NOME LIKE :NOME';
...
procedure TPessoa.ConsultarPorCpfCnpj(CPF_CNPJ: string);
var
  Query: TFDQuery;
begin
     Query := TFDQuery.Create(nil);
     try
            ...
            Query.SQL.Text := 'SELECT * FROM PESSOA WHERE CPFCNPJ = :CPFCNPJ';
            Query.ParamByName('CPFCNPJ').AsString := CPF_CNPJ;
